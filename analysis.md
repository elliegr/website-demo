...
<div id="dlqzdxyhen" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#dlqzdxyhen .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#dlqzdxyhen .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#dlqzdxyhen .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#dlqzdxyhen .gt_fraction_denominator {
  font-size: 0.6em;
  line-height: 0.6em;
...
#rlwuddpmut .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
![](analysis_files/figure-gfm/unnamed-chunk-9-1.png)<!-- --> We already
...
![](analysis_files/figure-gfm/unnamed-chunk-10-1.png)<!-- --> After ATO
